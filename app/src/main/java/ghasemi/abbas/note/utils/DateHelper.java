...
public class DateHelper {
    ...
    public static Date jalaliToGregorian(YearMonthDate jDate){
        ...
        secondCurrentMonth = jDate.getDate()* 86400L;
        ...
        //12600 is GMT+3:30
        second = second + (jDate.getHour()* 3600L)+(jDate.getMinutes()* 60L)+jDate.getSecond()-12600;
        second *= 1000;
    ...
    public static class YearMonthDate {
        ...
        public String toString() {
            return getDate() + " " + getMonthText() + " " + getYear() + " " + getHour() + ":"+getMinutes()+":"+getSecond();
        }
    }
}